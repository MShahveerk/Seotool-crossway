  ...
  if (!run) {
    return (
      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50/80 p-8 text-center text-sm text-gray-500">
        Run a post to see live stages, cost estimates, and caption preview here.
      </div>
    );
  }
        ...
        <div className="p-4 bg-[#fafcfa]">
          ...
          {preview.title || preview.caption ? (
            <div className="animate-soft-rise">
              <h3 className="text-lg font-semibold text-gray-900">{preview.title || "Untitled post"}</h3>
              {preview.platform && (
            ...
            <p className="text-sm text-gray-500">
              {live ? "Caption preview appears when the copywriter finishes…" : "No draft preview for this run."}
            </p>
          )}
        </div>
      </div>
