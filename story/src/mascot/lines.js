export const SAY = {
  ...
  "blog-board": "Drag a card to change status. Drop onto Published to go live now. Schedule does not matter.",
  ...
  "post-board": "Drop onto Published and it goes live now. A future schedule is ignored. Confirm first.",
