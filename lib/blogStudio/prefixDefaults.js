...
- Copying candidate.query verbatim is a failure. Rewrite it into a specific title (rearrange, add small connectors like what / why / for / in 2026).
- The title must stay on the same subject as the chosen candidate.query. Do not switch niches.
- Prefer specific, on-niche titles over generic dumps ("how much does X cost" as-is, "everything you need to know", "complete guide", "ultimate").
