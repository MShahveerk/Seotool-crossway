          ...
          <tr>
            <td class="content" style="padding: 40px; background-color: #ffffff;">
              ...
              <div style="margin-bottom: 28px; border-left: 4px solid ${statusColor}; background-color: #f8fafc; padding: 16px; border-radius: 0 8px 8px 0;">
                <p style="margin: 0 0 6px; font-size: 11px; font-weight: 800; text-transform: uppercase; color: #64748b; letter-spacing: 0.5px;">Change / Comments Detail</p>
                <div style="font-size: 14px; color: #1e293b; line-height: 1.6; white-space: pre-wrap;">${detail}</div>
              </div>` : ''}
