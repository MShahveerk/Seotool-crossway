              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding-bottom: 16px;">
                    <!-- Crossway Logo -->
                    <img src="${baseUrl}/crossway-logo.png" alt="Crossway Logo" width="55" height="55" style="display: inline-block; border-radius: 8px; background-color: #ffffff; padding: 4px;" />
                  </td>
                </tr>
                <tr>
                  <td align="center">
