...
export const CRON_JOB_CATALOG = [
  ...
  {
    id: "site-audit",
    label: "Daily site audits",
    schedule: "30 3 * * *",
    when: "Daily 03:30",
    description: "Runs internal site audits for known websites.",
    group: "seo",
    defaultEnabled: true,
    envFallback: null,
    dependency: null,
  ...
  {
    id: "seranking",
    label: "SE Ranking snapshots",
    schedule: "45 4 * * *",
    when: "Daily 04:45",
    description: "Cached SE Ranking refresh within the daily credit budget.",
    group: "seo",
    defaultEnabled: true,
    envFallback: null,
    dependency: null,
  ...
  },
  {
    ...
    label: "SE Ranking site explorer",
    schedule: "30 5 * * 1",
    when: "Mondays 05:30",
    description: "Weekly SE Ranking explorer refresh within credit caps.",
    group: "seo",
    defaultEnabled: true,
    envFallback: null,
    dependency: null,
