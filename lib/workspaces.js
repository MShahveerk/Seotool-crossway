...
export const WORKSPACES = [
  ...
  },
  {
    ...
    label: "SEO",
    icon: "search",
    /** Without a website selected only the explorer-driven tools are meaningful. */
    websiteOnlyExcept: ["site-intelligence", "keyword-research", "link-opportunities"],
    sections: [
