...
function mergeTwoAccounts(a, b) {
  ...
  const hasWebsite = isWebsiteKey(siteLink);
  ...
  return {
    ...
    type: hasWebsite ? "website" : facebookPageId ? "meta_page" : a.type || b.type || "website",
...
/** Collapse website + Meta rows that refer to the same client. */
