...
<body>
  <main class="card">
    ...
    <form method="POST" action="${escapeHtml(actionUrl)}">
      ...
      <textarea id="reason" name="reason" required maxlength="${QUICK_ACTION_REASON_MAX}" placeholder="e.g. Tone doesn't match our brand, SEO title needs work, wrong scheduling time…"></textarea>
