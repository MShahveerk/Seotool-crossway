...
Set "url" to the direct submission or claim page when known (not just the homepage).
Leave targetEmail empty unless a real public contact email exists — directory forms are filled on the web page, not by emailing Autopilot SMTP.

CRITICAL: Skip any directory/site already in the "DO NOT PITCH" blocklist (existing backlinks or prior pitches). Only new opportunities.`;
...
CRITICAL: Never pitch a domain that already links to this site, or that appears in the "DO NOT PITCH" blocklist in context. Only brand-new outreach targets.`;
