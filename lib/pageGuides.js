...
const GUIDES = {
  ...
  "blog-board": {
    title: "Blog board",
    steps: [
      s("board-lanes", "Lanes", "Draft through published. Drag a card to change status. Drop onto Published to go live now. A future schedule is ignored.", "blogs"),
  ...
  "my-blog-approvals": {
    ...
    steps: [
      ...
      s("approve-actions", "Approve or decline", "Approve schedules or publishes. Decline asks for a reason. Studio drafts can be sent back to Automation Studio to apply the corrections.", "blogs"),
  ...
  "post-board": {
    title: "Post board",
    steps: [
      s("board-lanes", "Lanes", "Social posts from idea to published. Drag to change status. Drop onto Published to go live now. Drag a published card back to Pending to delete it from Meta.", "social"),
  ...
  "my-approvals": {
    ...
    steps: [
      ...
      s("approve-actions", "Approve or decline", "Approve sends it toward publish. Decline asks for a reason. Studio posts can be sent back to Automation Studio to apply the corrections.", "social"),
  ...
  "link-opportunities": {
    ...
    steps: [
      ...
      s("link-run", "Find", "Free write-for-us, directories and listing forms are searched in parallel with rival backlinks. Unpaid is a confirmed free submit, claim, or contribute route.", "links"),
