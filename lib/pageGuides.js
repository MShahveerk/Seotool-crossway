...
const GUIDES = {
  ...
  "link-opportunities": {
    ...
    steps: [
      s("link-target", "Target", "The keyword and site you want links toward.", "links"),
      s("link-run", "Find", "Prospects that already rank on related terms or link to similar pages.", "links"),
      s("link-list", "Prospects", "Can pitch, unpaid, paid. Domain, origin, overlap, and a reason they are on the list. Origin lists only countries that appear in this result set.", "links"),
    ],
  },
  "blog-automation": {
    title: "Blog Studio",
