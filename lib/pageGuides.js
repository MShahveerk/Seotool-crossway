...
const GUIDES = {
  ...
  "link-opportunities": {
    ...
    steps: [
      s("link-target", "Target", "The keyword, the Google SERP location, and optionally a link origin country. Origin keeps only linking sites from that country.", "links"),
