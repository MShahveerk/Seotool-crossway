...
export const TAG_META = {
  ...
  new_topic: { label: "New topic", chip: "bg-emerald-100 text-emerald-800" },
  multi_source: { label: "Multi-engine", chip: "bg-violet-100 text-violet-800" },
  question: { label: "Question", chip: "bg-sky-100 text-sky-800" },
  commercial: { label: "Commercial", chip: "bg-amber-100 text-amber-800" },
  local: { label: "Local", chip: "bg-orange-100 text-orange-800" },
  long_tail: { label: "Long-tail", chip: "bg-gray-100 text-gray-600" },
  video_intent: { label: "Video", chip: "bg-red-100 text-red-800" },
  already_ranking: { label: "Ranking", chip: "bg-lime-100 text-lime-800" },
  striking_distance: { label: "Striking distance", chip: "bg-yellow-100 text-yellow-800" },
  weak_ranking: { label: "Weak rank", chip: "bg-gray-100 text-gray-600" },
};
