...
export const SECTION_META = {
  ...
  "seranking-domain": { label: "SEO Overview", group: "seranking" },
  "seranking-backlinks": { label: "Backlink Profile", group: "seranking" },
  "seranking-keywords": { label: "Keyword Explorer", group: "seranking" },
  "seranking-audit": { label: "SE Ranking Audit", group: "seranking" },
  "seranking-explorer": { label: "Site Explorer", group: "seranking" },
