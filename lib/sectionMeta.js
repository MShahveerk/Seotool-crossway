...
export const SECTION_META = {
  ...
  "device-appearance": { label: "Device & Appearance", group: "gsc" },
  "url-inspection": { label: "URL Inspection", group: "gsc" },
  "query-page-matrix": { label: "Query × Page", group: "gsc" },
  "sitemap-health": { label: "Sitemap Health", group: "gsc" },
  "seo-opportunities": { label: "SEO Opportunities", group: "gsc" },
  "pagespeed-insights": { label: "PageSpeed Insights", group: "seo" },
  ...
  "ai-keyword-research": { label: "AI Keyword Research", group: "seo" },
  "site-explorer": { label: "Site Explorer", group: "seo" },
  "link-index": { label: "Link Index", group: "seo" },
