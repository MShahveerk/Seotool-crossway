...
export const AUDIT_ISSUE_GUIDES = {
  ...
  loading_speed: guide("loading_speed", {
    ...
    description: "Total page load time exceeds the recommended threshold.",
...
export function getAuditIssueGuide(code, fallbackName, fallbackCategory) {
  ...
  return {
    ...
    severity: "notice",
    title,
    description: `${title} was reported by the site audit. Review affected URLs and apply the recommended fixes.`,
    ...
    fixSteps: [
      ...
      "Look up the issue code in standard SEO audit references if you need more context.",
