...
export const DATA_TYPES = {
  ...
  PROSPECT_PROBE: "prospect_probe",
  KEYWORD_OPPORTUNITIES: "keyword_opportunities",
  /** One-page Google SERPs used to find prospects beyond rival backlinks. */
...
export const TTL_DAYS = {
  ...
  [DATA_TYPES.LINK_DISCOVERY]: 3,
  /** A site rarely starts or stops accepting submissions week to week. */
  [DATA_TYPES.PROSPECT_PROBE]: 30,
  /** Ranking positions drift slowly; the per-domain keyword caches are 30d too. */
  [DATA_TYPES.KEYWORD_OPPORTUNITIES]: 14,
};
