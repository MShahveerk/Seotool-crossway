...
const ALL_DATAFORSEO = MODULE_SUB_PERMISSIONS[MODULES.DATAFORSEO].map((p) => p.id);
...
export const DEFAULT_ROLE_MODULE_PERMISSIONS = {
  [ROLES.SUPER_ADMIN]: {
    [MODULES.GSC]: ALL_GSC,
    [MODULES.SEO]: ALL_SEO,
    [MODULES.DATAFORSEO]: ALL_DATAFORSEO,
...
export const API_PATH_SECTION_MAP = [
  { pattern: /\/api\/dataforseo/, section: "dataforseo-explorer" },
