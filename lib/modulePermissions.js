...
export const MODULE_SUB_PERMISSIONS = {
  ...
  [MODULES.SERPER]: [{ id: "serper-explorer", label: "Serper Explorer" }],
};
...
const ALL_SERPER = MODULE_SUB_PERMISSIONS[MODULES.SERPER].map((p) => p.id);
...
function cloneRoleDefaults(role) {
  ...
  return {
    ...
    [MODULES.SERPER]: [...(defaults[MODULES.SERPER] || [])],
  };
}
...
export const MODULE_LABELS = {
  ...
  [MODULES.SERPER]: "Serper Explorer",
};
...
export const API_PATH_SECTION_MAP = [
  ...
  { pattern: /\/api\/serper/, section: "serper-explorer" },
